...
var sampleKeyPair = compute.KeyPairResponse{
	Name:        "keypairName",
...
func CreateComputeService(url string) compute.Service {
	return compute.NewService(common.SimpleAuthenticator{Token: tokn, ServiceURL: url})
}
...
type keyPairContainer struct {
	KeyPair compute.KeyPairResponse `json:"keypair"`
}
